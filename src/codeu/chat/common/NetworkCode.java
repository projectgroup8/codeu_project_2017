...
public final class NetworkCode {
  ...
  public static final int
      ...
      GET_UPDATES_BY_ID_REQUEST = 33,
      GET_UPDATES_BY_ID_RESPONSE = 34,
      NEW_USER_SUBSCRIPTION_REQUEST = 35,
      NEW_USER_SUBSCRIPTION_RESPONSE = 36,
      NEW_CONVERSATION_SUBSCRIPTION_REQUEST = 37,
      NEW_CONVERSATION_SUBSCRIPTION_RESPONSE = 38,
      CLEAR_UPDATES_REQUEST = 39,
      CLEAR_UPDATES_RESPOND = 40,
